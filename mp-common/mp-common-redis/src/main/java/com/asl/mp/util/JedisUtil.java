...
/**
 * Created by @author XuYangW on 2019/7/11 0011.
 **/
...
//
//        returnJedis(JedisUtil.getInstance().getJedis());
//
//        System.out.print("redis closed......");
//    }
    ...
    public class Keys {
         ...
         * 新增 修改 key
         */
        public String addOrUpdateKey(String key, String value) {
            Jedis jedis = getJedis();
